    ...
    constructor() {
        ...
        this.currencies = {
            'SGD': {
                ...
                deliveryRange: '7-9',
                productId: '3144',
                productName: 'Lenovo_Thinkplus_TH30_Headphones',
            ...
            'IDR': {
                ...
                deliveryRange: '4-8',
                productId: '3148',
                productName: 'Lenovo_Thinkplus_TH30_Headphones', /* The Name of Column in "all_customers_comments" Supabase Table and folder in "review-images" bucket */
